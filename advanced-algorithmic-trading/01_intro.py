...
# probability distributions, Bayesian Statistics and
...
# Decision Trees/ Support Vector Machines/ Random Forests/K-Means Clustering

# ---------------------- ----------------------

# price prediction, NLP, sentiment analysis then backtesting
